        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.btn_toast_2:
                    Toast toastCenter=Toast.makeText(getApplicationContext(),"ha...",Toast.LENGTH_SHORT);
                ...
                case R.id.btn_toast_3:
                    ...
                    ImageView imageView= (ImageView) view.findViewById(R.id.iv_taost);
                    TextView textView= (TextView)view. findViewById(R.id.tv_toast);
                    imageView.setImageResource(R.drawable.icon_checkbox_false);
                ...
                case R.id.btn_toast_4:
                    ToastUtil.showMsg(getApplicationContext(),"yeah");
                    break;
            }
        }
    }
